...
![Create a ClusterRoleBinding](./assets/screenshot-create_binding.png)>**NOTE:** Read the [Kubernetes documentation](https://kubernetes.io/docs/reference/access-authn-authz/rbac/) to learn more about Roles and RoleBindings.
